...
@msg_error_socket = private unnamed_addr constant [35 x i8] c"[Alien Stack] Error: socket failed.\0A\00"
@msg_error_bind   = private unnamed_addr constant [33 x i8] c"[Alien Stack] Error: bind failed.\0A\00"
@msg_error_listen = private unnamed_addr constant [35 x i8] c"[Alien Stack] Error: listen failed.\0A\00"
@msg_invariant_ok = private unnamed_addr constant [51 x i8] c"[Alien Stack] Invariant check: all invariants hold.\0A\00"
...
@msg_load_fail = private unnamed_addr constant [39 x i8] c"[Alien Stack] Error: asset load failed.\0A\00"
